...
// created on        : 2019-12-24T12:29:29.085+05:30
// created by        :
// generated by      : Sameer
...
module hello1_ids #(
    ...
    parameter hello1_address_width = addr_width
    )
    ...
    output [31 : 0] reg_name_f_r,    // FIELD : F
    ...
    output   reggroup1_reg1_enb,
    
    // READ DATA SIGNAL FOR EACH FIELD
    output [31 : 0] reggroup1_reg1_f_r,    // FIELD : F
    ...
    wire    reggroup1_reg1_decode;         // DECODE
    ...
    // BUFFER SIGNAL FOR EACH FIELD
    reg [31 : 0] reggroup1_reg1_f_q ;      // FIELD : F
    ...
    assign reg_name_decode  = (address[hello1_address_width-1 : 0]    == reg_name_offset[hello1_address_width-1 : 0] ) ? 1'b1 : 1'b0;
    ...
    always @(posedge clk)
        ...
        if (!reset_l)
            ...
            if (reg_name_wr_valid)   // F : SW Write
                begin
                    reg_name_f_q <=  ( wr_data[31 : 0] & reg_enb[31 : 0] ) | (reg_name_f_q & (~reg_enb[31 : 0]));
                end
    ...
    assign reg_name_rd_data = reg_name_decode ? {reg_name_f_q} : 32'b00000000000000000000000000000000;
    ...
    always @(posedge clk)
        ...
        if (!reset_l)
            begin
                ...
                reggroup1_reg1_f_q <= 32'd0;
            end
        else
            begin
                
            if (reggroup1_reg1_wr_valid)   // F : SW Write
                begin
                    reggroup1_reg1_f_q <=  ( wr_data[31 : 0] & reg_enb[31 : 0] ) | (reggroup1_reg1_f_q & (~reg_enb[31 : 0]));
                end
    ...
    // ===================================================
    // HW OUTPUT READ DATA FOR EACH FIELD
    assign reggroup1_reg1_f_r =  reggroup1_reg1_f_q;    // Field : F
    
    
    assign reggroup1_reg1_rd_data = reggroup1_reg1_decode ? {reggroup1_reg1_f_q} : 32'b00000000000000000000000000000000;
