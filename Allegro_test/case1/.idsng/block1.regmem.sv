...
class block1_reg1 extends uvm_reg;
    ...
    covergroup wr_cg_bits;
        ...
        option.name="block1_reg1_wr_cg_bits";
        `endif
    ...
    covergroup rd_cg_bits;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reg1_rd_cg_bits";
        `endif
    ...
    covergroup wr_cg_vals;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reg1_wr_cg_vals";
        `endif
    ...
    covergroup rd_cg_vals;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reg1_rd_cg_vals";
        `endif
...
class block1_reggroup1_reg1 extends uvm_reg;
    ...
    covergroup wr_cg_bits;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reggroup1_reg1_wr_cg_bits";
        `endif
    ...
    covergroup rd_cg_bits;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reggroup1_reg1_rd_cg_bits";
        `endif
    ...
    covergroup wr_cg_vals;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reggroup1_reg1_wr_cg_vals";
        `endif
    ...
    covergroup rd_cg_vals;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reggroup1_reg1_rd_cg_vals";
        `endif
...
class block1_reggroup1_reg2 extends uvm_reg;
    ...
    covergroup wr_cg_bits;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reggroup1_reg2_wr_cg_bits";
        `endif
    ...
    covergroup rd_cg_bits;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reggroup1_reg2_rd_cg_bits";
        `endif
    ...
    covergroup wr_cg_vals;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reggroup1_reg2_wr_cg_vals";
        `endif
    ...
    covergroup rd_cg_vals;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_reggroup1_reg2_rd_cg_vals";
        `endif
...
class block1_block extends uvm_reg_block;
    ...
    covergroup cg_addr;
        `ifdef INCA
        option.per_instance=1;
        option.name="block1_block_cg_addr";
        `endif
    ...
    virtual function void build();
        ...
        reg1.clear_hdl_path();
        reg1.add_hdl_path_slice("reg1_fld_q", 0, 32);
