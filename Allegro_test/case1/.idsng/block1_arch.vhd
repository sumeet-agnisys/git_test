...
-------------------------------------------------------------
-- ARCHITECTURE : block1_e ENTITY
-------------------------------------------------------------

architecture rtl of block1_e is
    ...
    -------------------------------------------
    -- block end address
    constant block1_end_addr : natural := 11;
    ...
    signal rdecode_reg1    : std_logic;                         -- read decode signal
    
    
    --: REGGROUP1:SECTION OFFSET RECORD
    type block1_reggroup1_offset is record
        reg1 : natural;
        reg2 : natural;
    end record;
    
    type block1_reggroup1_offset_array is array ((block1_reggroup1_count - 1) downto 0) of block1_reggroup1_offset;
    signal offset_reggroup1 : block1_reggroup1_offset_array;
    -- END SECTION OFFSET RECORD : REGGROUP1
    
    --: REGGROUP1:SECTION DECODE RECORD
    type block1_reggroup1_decode is record
        reg1 :std_logic;
        reg2 :std_logic;
    end record;
    
    type block1_reggroup1_decode_array is array ((block1_reggroup1_count - 1) downto 0) of block1_reggroup1_decode;
    signal decode_reggroup1 : block1_reggroup1_decode_array;
    -- END SECTION DECODE RECORD : REGGROUP1
    
    --: REGGROUP1:SECTION RDECODE RECORD
    type block1_reggroup1_rdecode is record
        reg1 :std_logic;
        reg2 :std_logic;
    end record;
    
    type block1_reggroup1_rdecode_array is array ((block1_reggroup1_count - 1) downto 0) of block1_reggroup1_rdecode;
    signal rdecode_reggroup1 : block1_reggroup1_rdecode_array;
    -- END SECTION RDECODE RECORD : REGGROUP1
    
    --: REGGROUP1:SECTION  RD_DATA RECORD : REGGROUP1
    type block1_reggroup1_rd_data is record
        reg1 : std_logic_vector((G_AXI_BUS_WIDTH - 1) downto 0);
        reg2 : std_logic_vector((G_AXI_BUS_WIDTH - 1) downto 0);
    end record;
    type block1_reggroup1_rd_data_array is array ((block1_reggroup1_count - 1) downto 0) of block1_reggroup1_rd_data;
    signal rd_data_reggroup1 : block1_reggroup1_rd_data_array;
    -- END SECTION RD_DATA RECORD : REGGROUP1
    
    --: REGGROUP1  SECTION  WRITE_VALID RECORD
    type block1_reggroup1_wr_valid is record
        reg1 : std_logic;
        reg2 : std_logic;
    end record;
    type block1_reggroup1_wr_valid_array is array ((block1_reggroup1_count - 1) downto 0) of block1_reggroup1_wr_valid;
    signal wr_valid_reggroup1 : block1_reggroup1_wr_valid_array;
    -- END  WRITE_VALID RECORD : REGGROUP1
    
    --: REGGROUP1 SECTION READ_VALID RECORD
    type block1_reggroup1_rd_valid is record
        reg1 : std_logic;
        reg2 : std_logic;
    end record;
    type block1_reggroup1_rd_valid_array is array ((block1_reggroup1_count - 1) downto 0) of block1_reggroup1_rd_valid;
    signal rd_valid_reggroup1 : block1_reggroup1_rd_valid_array;
    -- END READ_VALID RECORD : REGGROUP1
    
    type block1_reggroup1_q is record
        reg1_fld  : std_logic_vector(31 downto 0) ;
        reg2_fld1 : std_logic_vector(31 downto 0) ;
    end record;
    type block1_reggroup1_q_array is array ((block1_reggroup1_count - 1) downto 0) of block1_reggroup1_q;
    signal q_reggroup1 : block1_reggroup1_q_array;
    
    
    --  Register : REG1
    signal rd_data_reg1       : std_logic_vector(31 downto 0);    --  Read data signal
    signal wr_valid_reg1      : std_logic;                        --  Write valid signal
    signal rd_valid_reg1      : std_logic;                        --  Read valid signal
    
    signal q_reg1_fld : std_logic_vector(31 downto 0) ;     -- Field : FLD signal
    
    signal ext_out_d : block1_ext_outrec;     -- External out signal
    ...
    begin
        ...
        -- REGGROUP1 offset
        generate_reggroup1_offset : for reggroup1_i in (block1_reggroup1_count - 1) downto 0 generate
            offset_reggroup1(reggroup1_i).reg1 <= G_block1_offset + 4 + reggroup1_i * 8 + 0;
            offset_reggroup1(reggroup1_i).reg2 <= G_block1_offset + 4 + reggroup1_i * 8 + 4;
        ...
        -- REGGROUP1 decode
        generate_reggroup1_decode : for reggroup1_i in (block1_reggroup1_count - 1) downto 0 generate
        ...
        -- REGGROUP1 rdecode
        generate_reggroup1_rdecode : for reggroup1_i in (block1_reggroup1_count - 1) downto 0 generate
        ...
        decode_reg1 <= '1' when to_integer(unsigned(address(G_AXI_ADDR_WIDTH-1 downto 0))) = (offset_reg1 + G_block1_offset)  else '0';
        rdecode_reg1 <= '1' when to_integer(unsigned(raddress(G_AXI_ADDR_WIDTH-1 downto 0))) = (offset_reg1 + G_block1_offset)  else '0';
        ...
        rd_valid_reg1 <= '1' when  rdecode_reg1  = '1' and rd_stb = '1'  else '0';
                ...
                if reset_l = '0' then
                    ...
                    if (reg_in_enb.reg1_fld= '1')  then         --  HW write
                        ...
                        if ((wr_valid_reg1) = '1' ) then          --  SW Write
                            q_reg1_fld <= ( wr_data(31 downto 0) and reg_enb(31 downto 0) ) or (q_reg1_fld and (not(reg_enb(31 downto 0))));
        ...
        generate_reggroup1_reg_process : for  reggroup1_i in (block1_reggroup1_count - 1) downto 0 generate
        ...
        begin
            ...
            if (rd_valid_reg1 = '1') then
                rd_data0 <= rd_data_reg1;
            end if;
            
            loop_reggroup1_rd_data : for reggroup1_i in block1_reggroup1_count - 1 downto 0 loop
        ...
        wr_slave_select <= '1' when((slvwaddr(G_AXI_ADDR_WIDTH - 1 downto 0)  >= G_block1_offset) and (slvwaddr(G_AXI_ADDR_WIDTH - 1 downto 0)  <= G_block1_offset + block1_end_addr)) else '0';
        rd_slave_select <= '1' when((slvraddr(G_AXI_ADDR_WIDTH - 1 downto 0)  >= G_block1_offset) and (slvraddr(G_AXI_ADDR_WIDTH - 1 downto 0)  <= G_block1_offset + block1_end_addr)) else '0';
