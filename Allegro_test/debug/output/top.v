...
module top_ids(
    ...
    parameter top_address_width = addr_width;
    //-----------------------------------------------------
    ...
    //
    // FIELDS   :
    //     0:31 : f  ( SW : Read-Write HW : Read-only )
    ...
    assign reg_name_decode  = (address[top_address_width-1 : 0]    == reg_name_offset[top_address_width-1 : 0] ) ? 1'b1 : 1'b0;
