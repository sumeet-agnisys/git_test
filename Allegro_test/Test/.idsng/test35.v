...
// generated from    : D:\AgnisysProjects\git_test\Allegro_test\Test\test35.idsng
...
module test35_ids(
    ...
    parameter test35_address_width = addr_width;
    //-----------------------------------------------------
    ...
    reg reg_name_f1_q ;      // FIELD : F1
    
    // READ DATA SIGNAL FOR EACH FIELD
    output  reg_name_f1_r ;      // FIELD : F1
    ...
    //
    // FIELDS   :
    //        0 : f1  ( SW : Read-Write HW : Read-only )
    ...
    assign reg_name_decode  = (address[test35_address_width-1 : 0]    == reg_name_offset[test35_address_width-1 : 0] ) ? 1'b1 : 1'b0;
    ...
    always @(posedge clk)
        ...
        if (!reset_l)
            ...
            if (reg_name_wr_valid)   // F1 : SW Write
                begin
                    reg_name_f1_q <=  ( wr_data[0] & reg_enb[0] ) | (reg_name_f1_q & (~reg_enb[0]));
                end
    ...
    assign reg_name_rd_data = reg_name_decode ? {31'b0 ,reg_name_f1_q} : 32'b00000000000000000000000000000000;
