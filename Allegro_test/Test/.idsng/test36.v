...
// generated from    : D:\AgnisysProjects\git_test\Allegro_test\Test\test36.idsng
...
module test36_ids(
    ...
    parameter test36_address_width = addr_width;
    //-----------------------------------------------------
    ...
    assign reg_name_decode  = (address[test36_address_width-1 : 0]    == reg_name_offset[test36_address_width-1 : 0] ) ? 1'b1 : 1'b0;
    ...
    always @(posedge clk)
        ...
        if (!reset_l)
            ...
            if (reg_name_wr_valid)   // F : SW Write
                begin
                    reg_name_f_q <=  ( wr_data[0] & reg_enb[0] ) | (reg_name_f_q & (~reg_enb[0]));
                end
    ...
    assign reg_name_rd_data = reg_name_decode ? {31'b0 ,reg_name_f_q} : 32'b00000000000000000000000000000000;
