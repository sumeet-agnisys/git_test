...
var methods = {
    ...
    prepareTable : function (id) {
        ...
        for (var i = 0; i < size; i++) {
            ...
            if (! $.fn.jexcel.defaults[id].colWidths[i]) {
                $.fn.jexcel.defaults[id].colWidths[i] = $.fn.jexcel.defaults[id].defaultColWidth || '100';
            }
    ...
    createTable : function() {
        ...
        $(this).find('tbody').scroll(function() {
    ...
    setData : function(data, ignoreSpare) {
        ...
        for (j = 0; j < $.fn.jexcel.defaults[id].data.length; j++) {
            ...
            // Index column
            $(tr).append('<td class="jexcel_label" readonly>' + parseInt(j + 1) + '</td>'); 
