...
$(document).ready(function(){
    ...
    document.getElementById("spreadsheetcontainer").getElementsByClassName("exeltable")[0].addEventListener("mouseleave", function(event) { 
...
function placeCaretAtEnd(el) {
    console.log("--place care at end2");
    if (typeof window.getSelection != "undefined"
        && typeof document.createRange != "undefined") {
        console.log("if con "+el.nodeName);
        var range = document.createRange();
        var sel = window.getSelection();
        range.setStart(el, 1);
        range.collapse(true);
...
function pasterow(obj){
    if(copiedrows){
        ...
        console.log("--inner html : "+copiedrows);
        newrow.innerHTML=copiedrows;
        /*
        var rowindex=clickedEl.rowIndex;        
        var newEle=document.createElement("table");
        newEle.innerHTML=copiedrows;
        clickedEl.after(newEle.);
        */
        /*
            var rowindex=clickedEl.rowIndex;
            while(clickedEl.tagName.toUpperCase() !== "TABLE") {
...
function getHTMLOfSelection () {
    ...
    if (document.selection && document.selection.createRange) {
        ...
        if (selection.rangeCount > 0) {
            ...
            alert("--selected : "+clonedSelection);
...
function openexcelmenu(event){
    ...
    console.log("seletion : "+copiedrows);
    var x=event.pageX;
    var y=event.pageY;
