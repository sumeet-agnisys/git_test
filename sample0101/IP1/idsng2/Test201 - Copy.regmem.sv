...
/*----------------------------------------------------------------------
Class       : sample_top_reg_name33
DESCRIPTION:-
-----------------------------------------------------------------------*/
`ifndef CLASS_sample_top_reg_name33
`define CLASS_sample_top_reg_name33
class sample_top_reg_name33 extends uvm_reg;
    `uvm_object_utils(sample_top_reg_name33)

    rand uvm_reg_field reg33;/**/

    // Function : new
    function new(string name = "sample_top_reg_name33");
        super.new(name, 32, build_coverage(UVM_NO_COVERAGE));
        add_coverage(build_coverage(UVM_NO_COVERAGE));
    endfunction
    ...
    // Function : build
    virtual function void build();
        this.reg33 = uvm_reg_field::type_id::create("reg33");
        this.reg33.configure(.parent(this), .size(32), .lsb_pos(0), .access("RW"), .volatile(0), .reset(32'd0), .has_reset(1), .is_rand(1), .individually_accessible(0));
    endfunction
endclass
`endif
...
class sample_top_block extends uvm_reg_block;
    ...
    rand sample_top_reg_name33 reg_name33;
    ...
    virtual function void build();
        ...
        //REG_NAME33
        reg_name33 = sample_top_reg_name33::type_id::create("reg_name33");
        reg_name33.configure(this, null, "reg_name33");
        reg_name33.build();
        default_map.add_reg( reg_name33, 'h8, "RW");
